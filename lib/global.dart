    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          Container(
            height: 120,
            padding: EdgeInsets.only(top: 50, right: 20, left: 20, bottom: 5),
            child: Row(
              children: <Widget>[
                Expanded(
                  child: Container(
                ...
                SizedBox(width: 20,),
                FaIcon(FontAwesomeIcons.blog,size: 25,color: Colors.pink,)
              ],
            ),
          ),
          Expanded(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    //     children: <Widget>[
                    //       makeStory(
                    //           storyImage: 'assets/images/one.jpg',
                    //           userImage: 'assets/images/one.jpg',
                    ...
                    makeFeed(
                        ...
                        feedImage: 'assets/images/mani.png'
                    ),
                    makeFeed(
                        userName: 'Azamat Zhanisov',
                        userImage: 'assets/images/two.jpg',
                        feedTime: '3 mins ago',
                        ...
                        feedImage: 'assets/images/mani2.png'
                    ),
                    makeFeed(
                        userName: 'Azamat Zhanisov',
                        userImage: 'assets/images/three.jpg',
                        feedTime: '3 mins ago',
                        feedText: "All the Lorem Ipsum generators on the Internet tend to repeat predefined.",
                        feedImage: 'assets/images/mani3.png'
                    ),
                  ],
                ),
              ),
